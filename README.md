...
[CLAW Control](https://github.com/Clawdews/CLAW/tree/control-beta/control) pairs your accounts with Discord and follows your main's exact server. Open to everyone, with a separate group for each Discord user. [Setup guide](https://github.com/Clawdews/CLAW/blob/control-beta/docs/CONTROL-SETUP.md).
